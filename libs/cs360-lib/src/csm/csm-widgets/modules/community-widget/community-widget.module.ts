...
import { CommunityWidgetCsmComponent } from './community-widget-csm.component';
...
@NgModule({
  declarations: [CommunityWidgetCsmComponent],
  imports: [
    CommonModule,
    GridsterModule,
    DragDropModule,
  ...
  entryComponents: [CommunityWidgetCsmComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class CommunityWidgetModule { }
